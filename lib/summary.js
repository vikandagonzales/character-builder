if (document.querySelector('#character-summary') !== null) {
  ...
  document.querySelector('#race').innerHTML = JSON.parse(localStorage.getItem('subrace')) + ' ' + JSON.parse(localStorage.getItem('race'));
  document.querySelector('#level').innerHTML = JSON.parse(localStorage.getItem('level'));
  document.querySelector('#class').innerHTML = JSON.parse(localStorage.getItem('class'));
  document.querySelector('#subclass').innerHTML = JSON.parse(localStorage.getItem('subclass'));
  document.querySelector('#background').innerHTML = JSON.parse(localStorage.getItem('background'));
  document.querySelector('#alignment').innerHTML = JSON.parse(localStorage.getItem('alignment'));
