              ...
              <div id="character-tool">
                <article id="instructions" class="message is-primary hide">
                  <div class="message-body">
                    <span id="tool-addition" class="hide">Your character choices grant you the following <span id="tool-given"></span> tool proficiencies.</span>
                    <span id="tool-extras" class="hide">Please select <span id="artisan" class="hide"><span id="artisan-number"></span> artisan's tool<span class="plural hide">s</span></span><span class="comma hide">, </span><span class="and hide"> and </span><span id="gaming" class="hide"><span id="gaming-number"></span> gaming set<span class="plural hide">s</span></span><span class="comma hide">, </span><span class="and hide"> and </span><span id="music" class="hide"><span id="music-number"></span> musical instrument<span class="plural hide">s</span></span>.</span>
